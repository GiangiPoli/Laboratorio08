...
public class MiniGUI {
    ...
    public MiniGUI() {
        ...
        final JPanel otherCanvas = new JPanel();
        otherCanvas.setLayout(new BoxLayout(otherCanvas, BoxLayout.X_AXIS));
        canvas.add(otherCanvas, BorderLayout.CENTER);
        otherCanvas.add(write);
